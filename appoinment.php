...
<div class="row">
 ...
 <div class="table-responsive">
    ...
    float: right;
    margin-left: 9px;" class="sxdc"></span></th>
              <th style="width:350px"><span style="padding:0px !important"><span>Phone</span><input onkeyup="firstCapitalAlways(event)"  id='kkkcustomerphone' type="text" style="display:none;width: 200px;" /> <img src="searchp.png" style="width: 16px;
    margin-top: 7px;
    float: right;
    margin-left: 9px;" class="sxdc"></span></th>
 ...
 setInterval(function(){
  ...
  if(!window.isdatechange){
    regdate="";
      ...
      myajax( {"api":"allappointmentsboth","controllerid":xcontrollername,"xall":xall,"xnormal":xnormal,"xautorikshaw":xautorikshaw,"xmotorbike":xmotorbike,"regdate":regdate,"status":"<?php echo $status; ?>","ddate":ddate,"ishighest":ishighest},function( data, textStatus, jQxhr ){
        $("#loadinggif").hide();
