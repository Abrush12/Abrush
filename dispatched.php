              ...
              <div class="user_input_ro">
                  ...
                  <div class="col-md-6">
                    <div>
                      ...
                      <input type="text" style="margin-top:1px;padding-left:20px" id="fullname" onkeyup="firstCapitalAlways(event);" placeholder="Enter Name" class="_reddc"  tabindex="-1" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="left_ic">
