...
.no_bg,.no_bg *,.ispermanent,#datepicker,#datepicker1,#timerx,#timerx1,#clockx,#clockx1,#booking,#quotation,.left_ic img,.ccpaymenttype input[type='radio'],.date img,#fixedbx,.days_selected.selected span{cursor: pointer;}
 #confirm:focus{box-shadow: 1px 1px 20px #dedede;
    outline: 1px solid #dedede;}
     ...
     ._dfcntrlname{width: 183px;}
     .ctrlytable{ background: #fff;}
     .ctrlytable tr th,.ctrlytable tr td{    color: #000;
    padding: 4px;
    font-size: 13px;
 ...
 <div class="modal" id="confirmcancelmodal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="max-width: 700px; float: right; right: 100px; margin-top: 360px;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h4>Are you sure you want to cancel this job?</h4>
      
      </div>
      <div class="modal-footer" style="justify-content:start">
        
        <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
        <button type="button" class="btn btn-primary" id="cancellbk">Yes</button>
      </div>
    </div>
  </div>
</div>
...
<div style="margin-top: 32px;
    margin-left: 9px;"><div><label for="demo-radio-ampm-AM"><span class="value">AM</span> <span class="radio demoam timeselected" id="demoam"></span> </label></div><div class="clearfix"></div><div><label for="demo-radio-ampm-PM"><span class="value">PM</span><span class="radio demopm" id="demopm"></span> </label></div></div>
                          ...
                          <button type="button" style="margin-left: 13px" onclick="clopitimer(this,event)" class="amclose">Ok</button>
                      </div>
                         </div>
                      </div>
                    </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                    <div>
                      ...
                      <input type="text" style="margin-top:1px;padding-left:20px" id="fullname" placeholder="Enter Name" class="_reddc"  tabindex="-1" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="left_ic">
                         <div class="plholder pickuplocation" style=" margin-top:-8px;width: 185px;"><span>Pickup Location</span></div> 
    ...
    margin-left: -5px;">
                    ...
                    <div class="plholder viazdkk"><span></span></div>
                   ...
                   <div> 
                     ...
                     <div class="plholder droplocation"><span></span></div>
                         <div class="resulttry" onclick="showinpfld(this)"></div>
                      <input type="text"  onblur="reinitdbc(this,event)" style="margin-top:2px" autocomplete="off" id="droplocation" placeholder="Destination"> <div class="lcdropdown dropdrpdn"><div class="boldx allloading" style="display: none;">Loading...</div></div></div></div>
                   </div> 
                   <div class="col-sm-1" style="padding:0px;padding-left: 4px; max-width: 5.5%;  flex: 0 0 5.5%;margin-top: 4px;z-index:999">
                    ...
                    <div class="col-sm-3" style="padding:0px;padding-right:calc(0.2% + 8px);flex: 0 0 30%; max-width: 30%;margin-top: 4px;padding-left: 4px;z-index:999">
                         <div class="_ikmnp "> <input type="text"   autocomplete="off"  id="pickupnote" class="_reddc"  placeholder="Enter Note"> </div>
                         <div class="_ikmnp mnjjxz"> <input type="text"   autocomplete="off"   class="_reddc" placeholder="Enter Note"> </div>
                         <div class="_ikmnp "> <input type="text"   autocomplete="off"  id="dropnote" class="_reddc"  placeholder="Enter Note"> </div>
                    </div>
                  </div>
                 <!-- <div class="col-md-1">
...
<input type="text" style="margin-bottom:5px"  class="_reddc" autocomplete="off" id="notes" placeholder="Add notes for driver">
</div>
                  </div></div>
                ...
                <div class="row   "  style="margin: 0px;margin-bottom:10px; ">
                 ...
                 <div class="row   "  style="margin: 0px; ">
                  ...
                  <div class="col-sm-12" style="justify-content: center;"> 
                    ...
                    <li class="specialrequestimg"><img src="img/truck.png" ><span>Parcel</span>  <input type="checkbox"  class="chkcb"  id="parcel"><div class="mnbox"></div> </li>
                     </ul>
                    </div></div>
                <?php } ?>
    </div>
 <div class="clearfix"></div>
  ...
  <span class="round-btn"></span>
                ...
                <div class="days_selected">
                 ...
                 <button type="button" style="background:#858585;padding:2px 10px" class="confrm" id="edittime">Edit</button>
              </div>
                </div>
</div>   </div>
                 ...
                 <img src="img/Artboard 17 copy.png" id="opendatepicker1">
                  ...
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <input type="text" style="width:65%;font-size: 15px;font-weight: bold;height:21px" placeholder="10:35" onkeypress="formatTime(this)" maxlength="8" id="timerx1">
                         <img id="clockx1" src="img/clock.png" style="width:18px;position:absolute;margin:3px 5px 4px 10px;height: auto;"> 
                          <div class="timer-box mtr-datepicker">
                          <div class="mtr-row">
                            <div class="mtr-input-slider">
...
<div class="default-value-holder demominute" data-value="10"><div class="default-value demominute" data-value="10">10</div></div>
                             ...
                             <div class="mtr-input-radio"> 
<div style="margin-top: 32px;
    margin-left: 9px;"><div><label for="demo-radio-ampm-AM"><span class="value">AM</span> <span class="radio demoam" id="demoam1"  ></span> </label></div><div class='clearfix'></div><div><label for="demo-radio-ampm-PM"><span class="value">PM</span><span class="radio demopm" id="demopm1"  ></span> </label></div></div>
                            </div>
                          </div>
                           <div class="btns_cnfrm " style="margin-top: 0px;">
                  ...
                  <div class="col-md-6"  >
                      <div class="plholder pickuplocation" style=" margin-top:-8px; "><span>Pickup Location</span></div>
<input type="text" id="flightnumber" style="padding-left: 8px;"   class="_reddc" placeholder="Flight Number" autocomplete="off" class="input_flight">
                  </div>
...
<div style="height: 336px;background: #ffffff3c;padding:5px 5px 8px 0px">
              ...
              <div class="table_s table_xd tabledrivers" style="visibility: hidden;">
              ...
              <div class="row" style="margin-top: 7px;margin-left: 17px;visibility: hidden;">
               
                <div style="color:#fff;width:115px">Allocate driver</div>
                <div class="col-sm-7">
                <div id="allocateddriverlist"></div><input autocomplete="off" id="allocatedriver" class="_reddc" onkeyup="searchcallsign(this.value,event)" style="width:140px;padding-left: 3px;" type="text"><div class="ispermanent"><input style="width:9%;float:left;" type="checkbox" id="ispermanent">&nbsp;<span style="float:left;margin-left: 5px;"  >Permanent</span></div><div class="clearfix"></div>
   ...
   <div class="driverbox" >
              ...
              <div class="driver_bxxs">
                ...
                <span class="driver_details" style="width: 70%;">
          ...
          <div class="row" style="justify-content:center;"> <div class="btns_dr" style="margin-left: -20px;"  >
              ...
              <div class="atm_b" style="visibility: hidden;">
                ...
                <label class="col-sm-2 ccpaymenttype" >
                 ...
                 <label class="col-sm-5" style=" padding:0px 0px 0px 5px; margin-left: 5px;"> 
                   <div class="flex_lugge" style=" ">
...
<img src="img/load.gif" style="width: 57px;position: absolute;display: none;" id="loadingaxd">
                <div class="btns_cnfrm btns_cnfrmcx" style="margin-left: 0px; ">
                   <button type="button"  onclick="history.back()"  style="padding: 0px;width: 115px; ">Back</button>
...
window.lojob=function(job){
    ...
    window.isedit=false;
    $("#confirm").hide();
    $("#edit,#cancel,.audiobutton,._cover").show();
  $("._temprmpl").remove();
 ...
 window._addvia=function( ){
     ...
     window._crrvia++;
         ...
         $('<div class="_ikmn  axtempl"><img src="img/closenew.png" class="one_rab addcloseaclose" onclick="removevia(this,'+window._crrvia+')" ></div>').insertBefore(".firstlcf");
           $('<div class="_ikmnp  axtempl"> <input type="text"   autocomplete="off"   placeholder="Enter Note"> </div>').insertBefore(".mnjjxz");
...
window.rgst=function(ev){
     ...
     pagex=pagex-$(".custom-menu").width()+30;
...
$(document).mouseup(function(e) 
{
    ...
    var container = $(".xdropdown,.lcdropdown,.xallocatedriver,.custom-menu");
...
window.__xcheck=null;
        ...
        window.newaddvia=function(){
          ...
          $('<div class="_ikmn  axtempl"><img src="img/closenew.png" class="one_rab addcloseaclose" onclick="removevia(this,'+window._crrvia+')" ></div>').insertBefore(".firstlcf");
           $('<div class="_ikmnp  axtempl"> <input type="text"  autocomplete="off"   placeholder="Enter Note"> </div>').appendTo($(".mnjjxz").parent());
...
window.isclicked=false;
    ...
    window.jobid=0;
      ...
      const today = new Date();
       ...
       var obj=new Object();
         obj["api"]="getsearchbooking";
         obj["fullname"]="<?php echo $_GET['fullname']; ?>";
         obj["fromdate"]="<?php echo $_GET['fromdate']; ?>";
         obj["todate"]="<?php echo $_GET['todate']; ?>";
         obj["pickup"]="<?php echo $_GET['pickup']; ?>";
         obj["via"]="<?php echo $_GET['via']; ?>";
         obj["droplocation"]="<?php echo $_GET['droplocation']; ?>";
         obj["phonenumber"]="<?php echo $_GET['phonenumber']; ?>";
         obj["drivername"]="<?php echo $_GET['drivername']; ?>";
         obj["callsign"]="<?php echo $_GET['callsign']; ?>";
         obj["make"]="<?php echo $_GET['make']; ?>";
         obj["model"]="<?php echo $_GET['model']; ?>";
         obj["plateno"]="<?php echo $_GET['plateno']; ?>";
         obj["badgeno"]="<?php echo $_GET['badgeno']; ?>";
         obj["referencenumber"]="<?php echo $_GET['referencenumber']; ?>";
      myajax( obj,function( data, textStatus, jQxhr ){
        var html="";
     ...
     if(y.normal=="1") extras="Normal";
         ...
         html+='<td>'+y.bdate+'</td>';html+='<td>'+y.btime+'&nbsp;';
...
<table class='ctrlytable'><thead><tr><th>Day</th><th>Date</th><th>Time</th><th>Name</th></tr></thead><tbody></tbody></table>
</div>
    </div>
