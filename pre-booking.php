...
function GetLatlong(address) {
 ...
 <div class="modal" id="confirmsaloonmodalax" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="max-width: 700px; float: left; left: 39%; margin-top: 300px;">
    <div class="modal-content">
       
      <div class="modal-body">
        <h4>This passenger normally has a saloon car. 
<br><br>
Are you sure you want to take the saloon request off? Yes No
<br><br>
Do you want to remove saloon car as one off or permanently.
</h4>
      ...
      <div class="modal-footer" style="justify-content:start">
        ...
        <button type="button" class="btn btn-primary" id="yesaloonax">Yes</button>
      </div>
    </div>
  </div>
</div>
                    ...
                    <div class="form-group">
                      <div class="input-group time" style="width:200px;float:right">
                       ...
                       <input type="text" style="width:38%;margin-top:0px;font-weight: bold;font-size: 13px;margin-right: 10px;height: 22px;"  placeholder="--:--" onkeypress="formatTime(this)" MaxLength="8"    id="timerx">
                         <img id="clockx" src="img/clock.png" style="width:18px;position:absolute;margin:2px 5px 4px 10px;height: auto;"> 
...
<div style="margin-top: 32px;
    ...
    position: relative;">Quotation</span>
                </label> <div class="col-sm-6" style="justify-content:end">
         <button type="button"   class="audiobutton" id="audiolisten"  >Audio</button>
                </div>
              </div>
    ...
    margin-left: 10px;">
                ...
                <div id="mklht" class="row"  style="margin-left: 7px;margin-right: -25px; width: 153%;">
                     ...
                     <div> 
                       ...
                       <!--   <img src="img/arrow-down.png" class="drpdowncx"  />-->
                        ...
                        <img src="img/maps.png" class="mapsx dropmap" />
                         ...
                         <div class="resulttry" onclick="showinpfld(this)"></div>
                      <input type="text" onkeyup="firstCapitalAlways(event);" onblur="reinitdbc(this,event)" style="margin-top:2px" autocomplete="off" id="droplocation" placeholder="Destination"> <div class="lcdropdown"><div class="boldx allloading" style="display: none;">Loading...</div></div></div></div>
                   </div> 
...
<input type="text"  class="_reddc" autocomplete="off" style="margin-bottom:5px" id="notes" placeholder="Add notes for driver" onkeyup="firstCapitalAlways(event);" >
</div>
                  </div></div>
...
if(true){
 ?>
    <div class="col-sm-3" style="flex: 0 0 34%; max-width: 34%;padding-left: 20px;padding-right: calc(7.7% + 3px)"><div class="flex_lugge" style="">
...
<div class="clearfix"></div>
                  <div class="row" style=" margin: 0px;padding-right: calc(2.9% + 10px); ">
                  <div class="col-md-6"  >
...
<div style="height: 336px;background: #ffffff3c;padding:5px 5px 8px 0px;background-image:url('img/Artboard43_3.jpg')">
             ...
             <!--   <div class="checkbox_yes" style="margin-left:15px;visibility: hidden;color:white;">
              ...
              <div class="row" style="margin-top: 7px;margin-left: 17px;">
                ...
                <div class="col-sm-7">
                <div id="allocateddriverlist"></div><input autocomplete="off" id="allocatedriver" class="_reddc" onkeyup="searchcallsign(this.value,event)" style="width:140px;padding-left: 3px;" type="text">
...
<img src="img/load.gif" style="width: 57px;position: absolute;display: none;" id="loadingaxd">
              ...
              <button type="button" class="confrm" style="display:none;width:125px"  id="edit">Edit</button>
               <button type="button" id="cancel" style="margin-left:15px;display: none;padding:0px;width:125px;"  >Delete Booking</button>
      ...
      <div class="container-fluid" style="margin-top:-30px">
        <div class="row"> 
          ...
          <div class="col-md-12 px-0">
            <div class="table_bg_bar" style="margin-top:12px;padding:6px 16px">
...
window.errortype="0";
 ...
 init();
 $("#searchpickup").focus(function(){
    $(this).attr("placeholder","");
 }).blur(function(){
     $(this).attr("placeholder","Pick Up");
 })
 $("#searchdriver").focus(function(){
    $(this).attr("placeholder","");
 }).blur(function(){
     $(this).attr("placeholder","Driver");
 })
