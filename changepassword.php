...
<div class="row">
  ...
  <div class="col-sm-4">
   ...
   <label for="country" style="color: #fff !important; ">Enter Old Password</label>      
      
             <input type="text"    name="pswr"  autocomplete="current-password" class="form-control  " id="oldpassword"  >
 
  </div>
     <div class="form-group" style="margin-top:20px">
   <label   style="color: #fff !important; ">Enter New Password</label>      
        
             <input type="password" name="xlasa"   autocomplete="none" class="form-control secure" id="newpassword"  >
 
  </div>
</form>
   <div class="form-group" style="margin-top:20px">
    <label for="area" style="color:#fff">Re-Enter New Password </label>
    <input type="password" name="xlas"    class="form-control secure" id="cnewpassword"  >
