...
<html lang="en">
  ...
  .xdropdown,.xallocatedriver,.xbandriver{    z-index: 999;
    position: absolute;
    ...
    overflow-y: auto;}
    .xdropdown li,.xbandriver p,.xallocatedriver p{display: block;
    border-bottom: 1px solid #eaeaea;
    padding: 4px 5px;cursor: pointer;
    list-style-type: none;margin:0px;}
    .xdropdown li:hover,.xallocatedriver p:hover,.xbandriver p:hover{background:#eaeaea;}
    .xallocatedriver,.xbandriver{margin-top:0px;display: none;}
    .xallocatedriver .boldx,.xbandriver .boldx{width: 100%;text-align: center;padding:10px;color:#000;font-weight: bold;text-size:16px;display: none;}
...
.no_bg,.no_bg *,.ispermanent,#datepicker,#datepicker1,#timerx,#timerx1,#clockx,#clockx1,#booking,#quotation,.left_ic img,.ccpaymenttype input[type='radio'],.date img,#fixedbx,.days_selected.selected span{cursor: pointer;}
 #confirm:focus,#dispatchdriver:focus{box-shadow: 1px 1px 20px #dedede;
...
.greenccra{width: 14px;
 ...
 <link rel="stylesheet" href="css/bootstrap-clockpicker.min.css">
  ...
  .lcdropdown{width:calc(100% - 33px);margin-top:-15px;}
    ...
    list-style-type: none;margin:0px;}
    .xdropdown li:hover,.xallocatedriver p:hover, .pac-item:hover,.lcdropdown p:hover,.lcdropdown p.active,.xmapassengers li.active,.xallocatedriver p.active,.xbandriver p.active{background-color:#d9d9d9 !important;}
...
<div class="modal" id="cancelbookingmodalbv" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="max-width: 700px;float: right;
    right: 98px;
    top: 53%; ">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="justify-content:center;">
        ...
        <button type="button" class="btn btn-secondary"  id="cancelnodbv" data-dismiss="modal">No</button>
        <button type="button" class="btn btn-primary" id="cancelyesdbv">Yes</button>
      </div>
    </div>
  </div>
</div>
             ...
             <!--   <img src="img/arrow-down.png" class="drpdowncx"  />-->
                   ...
                   <div class="col-sm-1" style="padding:0px;padding-left: 4px; max-width: 5.5%;  flex: 0 0 5.5%;margin-top: 4px;z-index:999">
                    ...
                    <div class="col-sm-3" style="padding:0px;padding-right:calc(0.2% + 8px);flex: 0 0 30%; max-width: 30%;margin-top: 4px;padding-left: 4px;z-index:999">
                         <div class="_ikmnp "> <input type="text" onkeyup="firstCapitalAlways(event);"   autocomplete="off"  id="pickupnote" class="_reddc"  placeholder="Enter Note"> </div>
                         <div class="_ikmnp mnjjxz"> <input type="text" onkeyup="firstCapitalAlways(event);"   autocomplete="off"   class="_reddc" placeholder="Enter Note"> </div>
                         <div class="_ikmnp "> <input type="text" onkeyup="firstCapitalAlways(event);"   autocomplete="off"  id="dropnote" class="_reddc"  placeholder="Enter Note"> </div>
                    </div>
                  </div>
                 <!-- <div class="col-md-1">
...
<div style="height: 336px;background: #ffffff3c;padding:5px 5px 8px 0px;;background-image:url('img/Artboard43_4.jpg')">
             ...
             <!--   <div class="checkbox_yes amdriverbnv" style="margin-left:15px;color:white;">
              ...
              <div class="row" style="margin-top: 7px;margin-left: 17px;">
				...
				<!--<div class="ispermanent" style="display:none"><input style="width:9%;float:left;" type="checkbox" id="ispermanent" style="display:none">&nbsp;<span style="float:left;margin-left: 5px;"  >Permanent</span></div>--><div class="clearfix"></div>
...
window.dcounter=0;
 function checkKey(e) {
    ...
    if(e.keyCode==65&&!$("#allocatedriver").is(":focus") && !$("#txtbandriver").is(":focus")){
  ...
  window.istimeboxopen=false;
     ...
     if(e.keyCode=="39"){
         if($(".timer-box1").is(":visible")){
            ...
            return;
             ...
             else if($("#cancelbookingmodalbv").is(":visible")){
                $("#cancelyesdbv").focus();return;
            }

            
        if(!window.isedit){
             window.location.href="dispatched.php";
             return;
        }
     }
      if(e.keyCode=="37"){
    ...
    if (e.keyCode == '13') {
  if($("#cancelbookingmodal").is(":visible")){
    $('#cancelbookingmodal').modal("hide");
              $(".lcdropdown,#resetjob,#confirm").hide();
      $("._cover,#edit,#cancel").show();
    selectjobax(window.__jobref);return;
            }
         else  if($(".timer-box1").is(":visible")){
...
$(document).mouseup(function(e) 
{
    ...
    var container = $(".xdropdown,.lcdropdown,.xallocatedriver,.xbandriver,.custom-menu");
          ...
          $(".xdropdown li").on("click",function(e){ 
            ...
            if($(this).parent().hasClass("xaccount")){
              ...
              $("#errormodala").modal({"show":true});
                 ...
                 $("#cash,#prepaid").prop("disabled",true); //$("#cash,#prepaid,#deposit").prop("disabled",true);
            }
            else{
                $("#account").html("Select Account");
                 $("#cash,#prepaid").prop("disabled",false);  //$("#cash,#prepaid,#deposit").prop("disabled",false);
            }
            }
...
window.ccndr=function(){
    if(window._cjob==null){
        ...
        window.isedit=false;
                $("#cancelbookingmodalbv").modal("hide");
...
$("#depositamount,#cardnumber,#cardname,#cardexpirydate,#cardcvv,._ikmnp  input,#fullname,#mobile").val("");
	...
	const today = new Date();
     ...
     if(y.normal=="1") extras="Normal";
        ...
        // html+='<td>'+y.jobtype+'</td>';
         ...
         if(y.isprebooking=="1"){
            html+='<i class="fa fa-clock-o" style="margin-right:-20px"></i>&nbsp;';
         }
         html+='</td>';
